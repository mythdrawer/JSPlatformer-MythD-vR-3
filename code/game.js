...
Level.prototype.obstacleAt = function (pos, size) {
  ...
  //consider sides and top and bottom of the levels as  walls
  if (xStart < 0 || xEnd > this.width || yStart < 0 || yEnd > this.height)
    return "wall";
  //check each grid position starting at yStart, xStart//check for possible obstacles (non null value)
